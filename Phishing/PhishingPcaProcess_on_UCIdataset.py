...
def save_model(model, filename):
    import pickle
    from os import path
    pkl_filename = "E:/Anukriti/Avrutti Research/Task 9 Phishing/Dataset/savedFiles" + "/" + filename + ".pkl"
...
evaluate_classification_model(y_test, y_preds)
plotAUC(y_test, y_preds_prob, 'XG Boost')
save_model(rs_rf, 'Uci_PcaRfmodel')
